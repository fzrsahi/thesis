...
export const AdvisorDeleteModal = ({
  open,
  onOpenChange,
  onConfirm,
  title = "Hapus Dosen",
  description = "Tindakan ini tidak dapat dibatalkan. Data dosen akan dihapus permanen.",
  confirmText = "Hapus",
  variant = "dark",
}: AdvisorDeleteModalProps) => {
  ...
  const warningTextClass = isLight ? "text-zinc-800" : "text-zinc-100";
        ...
        <div className="space-y-4">
          ...
          <div className="py-4 text-center">
            <div className={warningWrapperClass}>
              ...
              <p className={`text-sm leading-6 ${warningTextClass}`}>{description}</p>
            </div>
          </div>
        </div>
