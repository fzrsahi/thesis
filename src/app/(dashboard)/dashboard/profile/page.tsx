...
import { User, Mail, Lock, Save, Eye, EyeOff, Calendar, Shield } from "lucide-react";
      ...
      <motion.div variants={staggerContainer} initial="hidden" animate="show" className="space-y-6">
            ...
            <Card className="border border-zinc-600/50 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 shadow-xl backdrop-blur-sm">
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
                  <div>
                    <p className="mb-1 text-zinc-400">ID Pengguna</p>
                    <p className="font-mono text-white">{profileData.id}</p>
                  </div>
                  <div>
                    <p className="mb-1 text-zinc-400">Role</p>
                    <p className="text-white capitalize">{session?.user?.role}</p>
                  </div>
                  <div>
                    <p className="mb-1 text-zinc-400">Akun Dibuat</p>
                    <p className="text-white">{formatDate(profileData.createdAt)}</p>
                  </div>
                  <div>
                    <p className="mb-1 text-zinc-400">Terakhir Diupdate</p>
        ...
        <motion.div variants={staggerItem} className="flex justify-end">
          <Button
            ...
            disabled={saving}
            className="rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-2 font-medium text-white transition-all duration-200 hover:from-blue-700 hover:to-blue-800 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {saving ? (
